...
KERNEL		= kernel.bin
OBJS		= kernel/kernel.o kernel/start.o kernel/global.o kernel/protect.o kernel/i8259A.o kernel/main.o kernel/process.o kernel/syscall.o kernel/clock.o kernel/keyboard.o lib/kliba.o lib/klib.o lib/mem.o
...
kernel/keyboard.o : kernel/keyboard.c include/type.h include/const.h include/proto.h
	$(CC) $(CFLAGS) -o $@ $<
